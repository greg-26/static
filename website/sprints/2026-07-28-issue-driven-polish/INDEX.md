...
- Current implementation phase: implementation has not started for this tranche.
...
| --- | --- | --- | --- |
| 023 | Movie-detail list actions are reachable immediately, and the poster can be inspected larger on mobile. | `ready` | Existing modal/list persistence |
| 024 | Movie-detail media surfaces feel native to Ohana: blended backdrop, internal collection/season links, compact one-row cast. | `ready` | Sprint 023 layout changes complete |
