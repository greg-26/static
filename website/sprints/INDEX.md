...
- Current planning status: issue-driven website tranche #7 and #13–#17 is implemented/verified; new issue #18 awaits planner triage.
- Current implementation phase: Sprints 10–22 are implemented; Sprints 10–17 are archived.
- Next executable sprint: none — no ready sprint remains until the planner triages issue #18 or new PMT feedback.
...
| 022 | Unblock local/Tailscale and production website API CORS verification by updating API-origin handling and documenting the smoke check. | `complete` — verified 2026-07-22; addresses cross-project issue #17. | API Worker deploy path from API Sprint 009; coordinate with API planner if another API sprint is active |
| 017 | Split movie-detail imagery into a horizontal TMDB/API hero image plus a proper portrait poster treatment. | `complete` — implemented, re-verified, and issue #13 closed 2026-07-22. | Sprint 11 API detail foundation complete |
...
- Issue #13 is covered by completed Sprint 017 and closed after fresh code/QA evidence on 2026-07-22. Do not create a duplicate sprint.
...
- Issue #17 was API-owned but website-relevant because it blocked local/Tailscale website review against the deployed API. Sprint 022 verified the deployed CORS contract for the required origins.
...
- Issue #13 is closed with Sprint 017 evidence: hero/backdrop hierarchy, portrait poster preservation, random backdrop selection, and fallback behavior.
...
- Issue #17 is closed with Sprint 022 local/Tailscale and production-origin CORS smoke evidence, plus Alex’s Tailscale confirmation.
