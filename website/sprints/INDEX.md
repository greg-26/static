...
- Current implementation phase: Sprints 023–028 are complete; Sprints 029–032 remain in the active tranche.
- Next executable sprint: [`Sprint 029 — Movie-detail list actions and scroll`](2026-07-28-open-issues-25-32/sprint-029-movie-detail-list-actions-and-scroll.md).
...
| 029 | Movie-detail list chips look persistent, include a manage-lists escape hatch, and related-title navigation resets modal scroll sanely. | `ready` | Current modal list actions and router behavior |
...
- Issues #27 and #28 are implemented in the movie-detail modal without changing list persistence semantics.
